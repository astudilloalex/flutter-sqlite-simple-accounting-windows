...
import 'package:simple_accounting_offline/ui/pages/pdf_journal_book/cubit/pdf_journal_book_state.dart';

class PDFJournalBookCubit extends Cubit<PDFJournalBookState> {
  PDFJournalBookCubit(
    ...
    this.startDate,
    this.endDate,
  }) : super(const PDFJournalBookState());
